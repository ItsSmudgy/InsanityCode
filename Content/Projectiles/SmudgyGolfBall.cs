...
{
	public class SmudgyGolfBall : ModProjectile
	{
		public override void SetStaticDefaults() {
			...
			DisplayName.SetDefault("Smudgy Ball"); // Note that the classname will appear in chat when the golf ball is sunk if you don't set a display name.
		}
