...
namespace Insanity.Content.Items.Consumables.BossSummons
{
	...
	public class OrbOfMight : ModItem
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Orb of Might");
			Tooltip.SetDefault("The power of Might in a single orb.");
		...
		public override bool CanUseItem(Player player) {
			...
			return !NPC.AnyNPCs(ModContent.NPCType<SpiritOfMight>());
		}
		...
		public override bool? UseItem(Player player) {
			if (player.whoAmI == Main.myPlayer) {
				...
				int type = ModContent.NPCType<SpiritOfMight>();
