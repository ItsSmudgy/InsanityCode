...
using Insanity.Content.Items.Weapons;
using Terraria.GameContent.Creative;
using Microsoft.Xna.Framework;
using Microsoft.Xna.Framework.Graphics;
using Terraria.GameContent;

namespace Insanity.Content.Items.Consumables
{
	// Basic code for a boss treasure bag
	public class SpiritOfMightBag : ModItem
	{
		// Sets the associated NPC this treasure bag is dropped from
		public override int BossBagNPC => ModContent.NPCType<SpiritOfMight>();
		...
		public override void OpenBossBag(Player player) {
			...
			if (Main.rand.NextBool(7)) {
				player.QuickSpawnItem(entitySource, ModContent.ItemType<SmudgyBall>());
			}

			player.QuickSpawnItem(entitySource, ModContent.ItemType<SpiritOfMightPetItem>());
		}
