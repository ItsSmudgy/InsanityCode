...
namespace Insanity.Content.Items.Placeable
{
	public class StardustTorch : ModItem
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Stardust Torch");
		...
		public override void SetDefaults() {
			...
			Item.createTile = ModContent.TileType<Tiles.Misc.StardustTorch>();
			Item.width = 10;
			Item.height = 12;
			Item.value = 50;
		}
