...
using Insanity.Content.NPCs.SpiritOfMight;
...
namespace Insanity.Content.NPCs.SpiritOfMight
{
	...
	public class MightProbe : ModNPC
	{
		...
		public static int BodyType() {
			return ModContent.NPCType<SpiritOfMightHead>();
		}
		...
		public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry) {
			...
			bestiaryEntry.Info.AddRange(new List<IBestiaryInfoElement> {
				...
				new FlavorTextBestiaryInfoElement("A probe powered by souls of might that guard the Spirit of Might. When all are destroyed, the Spirit of Might is vulnerable.")
			});
		}
		...
		private void MoveInFormation() {
			...
			float rad = (float)PositionIndex / SpiritOfMightHead.MinionCount() * MathHelper.TwoPi;
