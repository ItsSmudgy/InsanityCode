	...
	internal class Intestiworm_Head : WormHead
	{
		...
		public override void SetStaticDefaults() {
			...
			var drawModifier = new NPCID.Sets.NPCBestiaryDrawModifiers(0) { // Influences how the NPC looks in the Bestiary
				CustomTexturePath = "Insanity/Content/NPCs/Intestiworm_Bestiary", // If the NPC is multiple parts like a worm, a custom texture for the Bestiary is encouraged.
		...
		public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry) {
			...
			bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[] {
				...
				new FlavorTextBestiaryInfoElement("A disgusting, intestine-like worm from the underground area of the Corrosion.")
			});
		}
