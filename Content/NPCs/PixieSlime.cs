...
namespace Insanity.Content.NPCs
{
	...
	public class PixieSlime : ModNPC
	{
		...
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Pixie Slime"); // Automatic from localization files
		...
		public override void SetDefaults() {
			...
			NPC.lifeMax = 125; // The amount of health that this npc has
			NPC.HitSound = SoundID.NPCHit5; // The sound the NPC will make when being hit.
			NPC.DeathSound = SoundID.NPCDeath7; // The sound the NPC will make when it dies.
		...
		public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
		{
			...
			bestiaryEntry.Info.AddRange(new List<IBestiaryInfoElement> {
				...
				new FlavorTextBestiaryInfoElement("Pixies that were consumed by slimes. It's as simple as that.")
			});
		}
