...
{
	public class VortexTorch : ModTile
	{
		...
		public override void SetStaticDefaults() {
			...
			ItemDrop = ModContent.ItemType<Items.Placeable.VortexTorch>();
			...
			name.SetDefault("Vortex Torch");

			AddMapEntry(new Color(200, 200, 200), name);

			// Assets
			if (!Main.dedServ) {
				flameTexture = ModContent.Request<Texture2D>("Insanity/Content/Tiles/Misc/VortexTorch_Flame");
			}
		}
