...
namespace Insanity.Content.Tiles.Misc
{
	public class StardustTorch : ModTile
	{
		...
		public override void SetStaticDefaults()
		{
			...
			ItemDrop = ModContent.ItemType<Items.Placeable.StardustTorch>();
			...
			name.SetDefault("Stardust Torch");
			...
			if (!Main.dedServ)
			{
				flameTexture = ModContent.Request<Texture2D>("Insanity/Content/Tiles/Misc/StardustTorch_Flame");
			}
		}
