...
{
	public class NebulaTorch : ModTile
	{
		...
		public override void SetStaticDefaults()
		{
			...
			ItemDrop = ModContent.ItemType<Items.Placeable.NebulaTorch>();
			...
			if (!Main.dedServ)
			{
				flameTexture = ModContent.Request<Texture2D>("Insanity/Content/Tiles/Misc/NebulaTorch_Flame");
			}
		}
