...
{
	public class SolarTorch : ModTile
	{
		...
		public override void SetStaticDefaults()
		{
			...
			ItemDrop = ModContent.ItemType<Items.Placeable.SolarTorch>();
			...
			if (!Main.dedServ)
			{
				flameTexture = ModContent.Request<Texture2D>("Insanity/Content/Tiles/Misc/SolarTorch_Flame");
			}
		}
